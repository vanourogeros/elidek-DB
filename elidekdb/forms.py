...
class ProgramUpdate(FlaskForm):  
    ...
    sector = StringField(u'Sector name', validators = [DataRequired(message = "Sector is a required field.")])
...
class updateRes(FlaskForm):
    ...
    r_date = DateField(label = "Recruitement Date", validators = [DataRequired(message = "Recruitement Date is a required field.")])
